// Showing the top entities in bubbles.
// hovering on a bubble shows the connections to other bubbles on the screen
// using SVD (PCA) to find locate each bubble on the screen
